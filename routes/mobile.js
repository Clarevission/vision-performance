...
router.post('/', async (req, res) => {
  ...
  const html = `
    ...
    <table style="font-family:sans-serif;font-size:14px;border-collapse:collapse;width:100%">
      ...
      <tr style="background:#f9f9f9"><td style="padding:8px;color:#666"><strong>Phone</strong></td><td style="padding:8px">${safe(phone) || 'â€”'}</td></tr>
      <tr><td style="padding:8px;color:#666"><strong>Employees</strong></td><td style="padding:8px">${safe(employees) || 'â€”'}</td></tr>
      <tr style="background:#f9f9f9"><td style="padding:8px;color:#666"><strong>Preferred Date</strong></td><td style="padding:8px">${safe(date) || 'â€”'}</td></tr>
  ...
  try {
    await sendMail({
      ...
      subject: `[Mobile Clinic Request] ${safe(org)} â€” ${safe(employees) || 'Unknown size'}`,
      html,
    ...
    await sendMail({
      to: safeEmail,
      subject: 'Mobile Clinic Request Received â€” Vision Performance Inc.',
